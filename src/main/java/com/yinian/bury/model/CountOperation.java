...
public class CountOperation {
    ...
    public String getGroupNewType() {
        return groupNewType;
    }

    public void setGroupNewType(String groupNewType) {
        this.groupNewType = groupNewType == null ? null : groupNewType.trim();
    }
